...
public class FXMLController {
	...
	void doCreaGrafo(ActionEvent event) {
		...
		if (m == null) {
			this.txtResult.appendText("Selezionare un match!");
			return;
		}
		
		model.creaGrafo(m);

		String res = "Grafo creato\n# VERTICI: " + model.getNVertices() + "\n# ARCHI: " + model.getNEdge();
